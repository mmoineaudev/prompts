...
| 5 | HUNTER | 30 s (cap 90) | spectral companion follows and lashes enemies (below) |

- **Sources**: breaking breakables rolls `BUFF.CHANCE = 6%` per break, +0.05% per orb above 100. Boss kills grant `BUFF.BOSS_DURATION = 300 s` (5 min), NOT capped by the 90 s ceiling.
