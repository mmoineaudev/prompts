...
Run the specific test according to the project stack.
...
Run the specific test, then run ALL tests to check for regressions.
...
- **GREEN** — verify the test passes with minimal code
- **Full suite** — verify no regressions after each cycle
